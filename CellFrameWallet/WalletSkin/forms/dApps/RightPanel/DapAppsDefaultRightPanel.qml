...
//            Layout.margins: 3 
            ...
            DapRadioButton
            {
                ...
                onClicked: {
                    currentStatusSelected(qsTr("Verified"))
                }
            }
            ...
            DapRadioButton
            {
                ...
                implicitHeight: indicatorInnerSize
                onClicked: {
                    currentStatusSelected(qsTr("Unverified"))
                }
            }
            ...
            DapRadioButton
            {
                ...
                implicitHeight: indicatorInnerSize
                onClicked: {
                    currentStatusSelected(qsTr("Both"))
                }
                checked: true
            }
        }
    ...
    //                messagePopup.smartOpen(qsTr("Add Plugin"),qsTr("Input name plugin"))
            ...
            DapButton
            {
                ...
                onClicked:
                {
                    ...
                    pluginsController.installPlugin(namePlugin, 1,dapAppsModel.get(dapListViewApps.currentIndex).verifed)
            ...
            DapButton
            {
                ...
                onClicked:
                {
                    ...
                    var namePlugin = dapAppsModel.get(dapListViewApps.currentIndex).name
                    pluginsController.installPlugin(namePlugin, 0, dapAppsModel.get(dapListViewApps.currentIndex).verifed)
                    logicMainApp.activePlugin = ""
    ...
    //                    listModel.remove(listViewPlug.currentIndex)
                    pluginsController.deletePlugin(dapAppsModel.get(dapListViewApps.currentIndex).urlPath)
                    logicMainApp.activePlugin = ""
