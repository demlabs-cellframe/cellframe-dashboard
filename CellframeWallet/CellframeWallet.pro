...
include (../cellframe-ui-sdk/web3_api/web3_api.pri)
...
mac {
    ICON = Resources/CellframeWallet.icns
}
else: !win32 {
...
linux-* {
    ...
    share_target.path = /opt/cellframe-wallet/
...
mac {
    ...
    WALLET_RESOURCES.files += $$_PRO_FILE_PWD_/../os/macos/cellframe-uninstaller \
	$$_PRO_FILE_PWD_/../os/macos/uninstall \
	$$_PRO_FILE_PWD_/../os/macos/uninstall_icon.rsrc
    WALLET_RESOURCES.path = Contents/Resources

    WALLET_CLEANUP_RESOURCES.files += $$_PRO_FILE_PWD_/../os/macos/cleanup/
    WALLET_CLEANUP_RESOURCES.path = Contents/Resources/cleunup/
        
    QMAKE_BUNDLE_DATA += WALLET_RESOURCES WALLET_CLEANUP_RESOURCES
