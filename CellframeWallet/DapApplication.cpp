...
using namespace Dap::WalletDefines;
...
{
    QDir dirApp(WalletStorage::STORAGE_PATH);
    QDir dirLogs(WalletStorage::LOG_PATH);
    QDir dirDapps(WalletStorage::DAPPS_PATH);
    QDir dirDappsDownload(WalletStorage::DAPPS_DOWNLOAD_PATH);
    QDir dirData(WalletStorage::DATA_PATH);
    QDir dirDataWallet(WalletStorage::WALLET_PATH);
    QDir dirDataWalletNode(WalletStorage::WALLET_NODE_PATH);
...
void DapApplication::setGuiApp(DapGuiApplication *guiApp)
{
    ...
    QAndroidIntent serviceIntent(QtAndroid::androidActivity().object(),
                                 "com/Cellframe/Wallet/WalletService");
...
void DapApplication::initMigrateWallets()
{
    if(m_serviceController)
    {
        ...
        QVariantMap request = {{Dap::KeysParam::PATH_WALLETS_FROM, Dap::CommonKeys::DEFAULT}
                              ,{Dap::KeysParam::PATH_WALLETS_TO, Dap::WalletDefines::WalletStorage::WALLET_NODE_PATH}};
