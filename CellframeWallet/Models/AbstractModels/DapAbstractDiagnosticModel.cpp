...
static const QHash<QString, DapAbstractDiagnosticModel::DapAbstractDiagnosticModel::FieldId> s_fieldIdMap =
{
    ...
    {"system_uptime_wallet",       DapAbstractDiagnosticModel::FieldId::system_uptime_wallet},
...
QVariant DapAbstractDiagnosticModel::_getValue (const DapAbstractDiagnosticModel::Item &a_item, int a_fieldId)
{
  switch (DapAbstractDiagnosticModel::FieldId (a_fieldId))
    ...
    case DapAbstractDiagnosticModel::FieldId::system_uptime_wallet   :  return a_item.system_uptime_wallet;
...
void DapAbstractDiagnosticModel::_setValue (DapAbstractDiagnosticModel::Item &a_item, int a_fieldId, const QVariant &a_value)
{
  switch (DapAbstractDiagnosticModel::FieldId (a_fieldId))
    ...
    case DapAbstractDiagnosticModel::FieldId::system_uptime_wallet   :  a_item.system_uptime_wallet   = a_value.toString(); break;
  ...
  : d (a_data)
{
  ...
  connect (d->model, &QAbstractTableModel::dataChanged,
           this, &ItemDiagnosticBridge::system_uptime_walletChanged);
  connect (d->model, &QAbstractTableModel::dataChanged,
...
QString ItemDiagnosticBridge::system_uptime_wallet() const
{
  return (d && d->item) ? d->item->system_uptime_wallet : QString();
}

void ItemDiagnosticBridge::setsystem_uptime_wallet (const QString &system_uptime_wallet)
{
  if (!_beginSetValue())
    return;
  d->item->system_uptime_wallet   = system_uptime_wallet;
  emit system_uptime_walletChanged();
  _endSetValue();
}
...
QVariant ItemDiagnosticBridge::operator[] (const QString &a_valueName)
{
  ...
  switch (DapAbstractDiagnosticModel::FieldId (fieldId))
    ...
    case DapAbstractDiagnosticModel::FieldId::system_uptime_wallet   :  return system_uptime_wallet(); break;
