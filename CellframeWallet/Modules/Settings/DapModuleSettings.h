...
public:
    ...
    Q_PROPERTY(QString walletVersion READ walletVersion NOTIFY walletVersionChanged)
    Q_INVOKABLE QString walletVersion(){return m_walletVersion;}
...
public:
    ...
    QString m_walletVersion{DAP_VERSION};
