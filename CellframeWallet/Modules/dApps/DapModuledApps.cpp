...
{
    m_pathPluginsListFile = WalletDefines::DApps::PLUGINS_CONFIG;
...
void DapModuledApps::initPlatformPaths()
{
    ...
    m_dappsFolder = WalletDefines::DApps::PLUGINS_PATH;
    m_dappsDownloadFolder = WalletDefines::DApps::PLUGINS_DOWNLOAD_PATH;
}
