    ...
    Rectangle
    {
        ...
        Rectangle
        {
            ...
            DapComboBox
            {
                ...
                fontComboBox: [dapMainFonts.dapFont.dapFontRobotoRegular14]
        ...
        Rectangle
        {
            ...
            Text
            {
                ...
                color: "#757184"
                font.family: dapMainFonts.dapFont.dapFontRobotoRegularCustom
        ...
        Rectangle
        {
            ...
            Rectangle
            {
                ...
                Text
                {
                    ...
                    width: 336 * pt
                    color: "#070023"
                    font: dapMainFonts.dapFont.dapFontRobotoRegular16
                    anchors.verticalCenter: parent.verticalCenter
                }
                ...
                header:
                    Rectangle
                    {
                        ...
                        Text
                        {
                            ...
                            text: qsTr("Time")
                            color: "#757184"
                            font.family: dapMainFonts.dapFont.dapFontRobotoRegular10
                            anchors.top: parent.top
                            anchors.left: parent.left
                            width: 149 * pt
                        }
