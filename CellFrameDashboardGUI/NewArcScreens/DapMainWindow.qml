...
import "qrc:/widgets"
import "../NewArcScreens"
import "qrc:/resources/QML"
import "../NewArcScreens/controls"
...
FocusScope {
    ...
    readonly property string dashboardScreen: "qrc:/NewArcScreens/desktop/Dashboard/DapDashboardTab.qml"
    readonly property string walletScreen: "qrc:/NewArcScreens//Wallet/WalletPage.qml"
    readonly property string exchangeScreen: "qrc:/NewArcScreens/desktop/Exchange/DapExchangeTab.qml"
    readonly property string historyScreen: "qrc:/NewArcScreens/desktop/History/TXHistoryPage.qml"
    readonly property string certificatesScreen: "qrc:/NewArcScreens/desktop/Certificates/DapCertificatesMainPage.qml"
    readonly property string tokensScreen: "qrc:/NewArcScreens/desktop/Tokens/DapTokensTab.qml"
    readonly property string vpnClientScreen: "qrc:/NewArcScreens/desktop/VPNClient/VPNClientPage.qml"
    readonly property string vpnServiceScreen: "qrc:/NewArcScreens/desktop/VPNService/DapVPNServiceTab.qml"
    readonly property string consoleScreen: "qrc:/NewArcScreens/desktop/Console/DapConsoleTab.qml"
    readonly property string logsScreen: "qrc:/NewArcScreens/desktop/Logs/DapLogsTab.qml"
    readonly property string appsScreen: "qrc:/NewArcScreens/desktop/dApps/DapAppsTab.qml"
    readonly property string settingsScreen: "qrc:/NewArcScreens/desktop/Settings/DapSettingsTab.qml"
    readonly property string underConstructionsScreen: "qrc:/NewArcScreens/desktop/UnderConstructions.qml"
    readonly property string testScreen: "qrc:/NewArcScreens/desktop/Test/TestPage.qml"
...
//                    Layout.margins: 10
    ...
    Connections {
        ...
        onWalletsReceived: {
            _dapModelWallets = globalLogic.rcvWalletList(walletList, parent, networkArray)
            networkArray = globalLogic.rcvNetworkArray(_dapModelWallets)
            modelWalletsUpdated();
        }
        onOrdersReceived:
        {
