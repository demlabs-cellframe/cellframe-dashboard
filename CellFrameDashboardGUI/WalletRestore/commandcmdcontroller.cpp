...
"wallet new -w <wallet_name> -force"
"wallet new -w <wallet_name> -net <net_name> "
"wallet new -w <wallet_name> -net <net_name> -force"
"wallet new -w <wallet_name> -restore <hex value>  "
"wallet new -w <wallet_name>  -restore <hex value>  -force"
"wallet new -w <wallet_name>  -restore <hex value> -net <net_name> "
"wallet new -w <wallet_name>  -restore <hex value> -net <net_name> -force"
"wallet new -w <wallet_name> -sign <sign_type>   "
"wallet new -w <wallet_name> -sign <sign_type>   -force"
"wallet new -w <wallet_name> -sign <sign_type>  -net <net_name> "
"wallet new -w <wallet_name> -sign <sign_type>  -net <net_name> -force"
"wallet new -w <wallet_name> -sign <sign_type> -restore <hex value>  "
"wallet new -w <wallet_name> -sign <sign_type> -restore <hex value>  -force"
"wallet new -w <wallet_name> -sign <sign_type> -restore <hex value> -net <net_name> "
"wallet new -w <wallet_name> -sign <sign_type> -restore <hex value> -net <net_name> -force"
"wallet  list "
...
QString CommandCmdController::getCommandParams(const QString &value, int count)
{
    ...
    //qDebug() << "lililist" << val << count << list;
