                ...
                MouseArea {
                    ...
                    onClicked: {
                        if (!networkListPopups[index].isOpen) {
                            networksPanel.updateContentInSpecifiedPopup(networkListPopups[index], dapNetworkList.model.get(index))
...
//                console.log("Network : "+ dapOrders[i].Network)
        ...
        onNetworksStatesReceived:
        {
            ...
            networksPanel.recreatePopups(dapNetworkList.model, networkListPopups)
