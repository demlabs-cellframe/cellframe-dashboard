...
Page
{
    ...
    DapRectangleLitAndShaded
    {
        ...
        height: {
            if(dapSettingsScreen.height > contentData.implicitHeight)
                return contentData.implicitHeight > 105 ? contentData.implicitHeight : 105
            else
                return dapSettingsScreen.height
        }
