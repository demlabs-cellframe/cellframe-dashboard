                ...
                Rectangle
                {
                    ...
                    ColumnLayout
                    {
                        ...
                        Item
                        {
                            ...
                            RowLayout
                            {
                                ...
                                DapButton
                                {
                                    ...
                                    fontButton: _dapQuicksandFonts.dapMainFontTheme.dapFontQuicksandRegular11
                        ...
                        DapButton
                        {
                            ...
                            borderWidthButton: 0
                            fontButton.family:  _dapQuicksandFonts.dapMainFontTheme.dapFontQuicksandRegularCustom
    ...
    Component
    {
        ...
        ItemDelegate
        {
            ...
            Text
            {
                ...
                text: time
                color: "#4F5357"
                font.family:  _dapQuicksandFonts.dapMainFontTheme.dapFontQuicksandRegular12
                anchors.left: parent.left
                anchors.top: parent.top
            ...
            Text
            {
                ...
                font.family:  _dapQuicksandFonts.dapMainFontTheme.dapFontQuicksandRegular10
            ...
            Text
            {
                ...
                text: price
                color: "#4F5357"
                font.family:  _dapQuicksandFonts.dapMainFontTheme.dapFontQuicksandRegular11
