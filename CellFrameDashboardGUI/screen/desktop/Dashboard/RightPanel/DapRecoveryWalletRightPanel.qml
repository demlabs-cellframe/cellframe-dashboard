...
DapRecoveryWalletRightPanelForm
{
    ...
    Connections
    {
        ...
        onClipboardError:
        {
            ...
            dapButtonAction.colorBackgroundButton = "#3E3853"
            dapButtonAction.colorTextButton = "#FFFFFF"
    ...
    dapButtonAction.onClicked:
    {
        ...
        dapButtonAction.colorBackgroundButton = "#EDEFF2"
        dapButtonAction.colorTextButton = "#3E3853"
    ...
    FileDialog {
        ...
        nameFilters: [qsTr("Wallet recovery files (*.walletbackup)")]
        onAccepted:
        {
