...
pkgbuild --install-location /Applications --identifier com.demlabs.$APP_NAME --scripts $PKGSCRIPT_PATH --component-plist $wd/$BUILD_PATH/$APP_NAME.plist --root $wd/$BUILD_PATH/ $wd/$BUILD_PATH/$APP_NAME-$VERSION_INFO.pkg
